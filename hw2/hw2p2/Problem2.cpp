...
int main()
{
   ...
   U_CHAR *data1, *data2, *data3, *new_data, color_table1[1024];
   ...
   i = ReadDataSize("Fig0227(a)(washington_infrared).bmp");
   data1 = (U_CHAR *)malloc( i );
   if (data1 == NULL) {
      exit(0);
   }

   ReadImageData("P2_zerols.bmp", bmpfileheader1, bmpinfoheader1, color_table1, data1);
   ...
   ReadImageData("Fig0227(a)(washington_infrared).bmp", bmpfileheader1, bmpinfoheader1, color_table1, data2);
   ...
   //
   /* �}�ҷs�ɮ� */
   if( ( output_file = fopen("P2.bmp","wb") ) == NULL ){
